 ...
 * credentials. Access is controlled by the Firestore/Storage security rules.
...
const firebaseConfig = {
  ...
  storageBucket:
    process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || "greenguardian2026.firebasestorage.app",
